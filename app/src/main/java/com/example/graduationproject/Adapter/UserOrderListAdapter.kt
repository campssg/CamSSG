...
class UserOrderListAdapter(val itemList: ArrayList<UserOrderListResponse>):RecyclerView.Adapter<UserOrderListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: UserOrderListAdapter.ViewHolder, position: Int) {
        ...
        holder.reservedAt_day.text = "${itemList[position].reservedAt.month}/${itemList[position].reservedAt.dayOfMonth}"
        holder.reservedAt_time.text = "${itemList[position].reservedAt.hour}:${itemList[position].reservedAt.minute}"
    }
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        val reservedAt_day : TextView = itemView.findViewById(R.id.textView30)
        val reservedAt_time : TextView = itemView.findViewById(R.id.pickuptime_orderItem)
